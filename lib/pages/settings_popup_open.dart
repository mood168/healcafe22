...
class SettingsPopupOpen extends StatefulWidget {
  const SettingsPopupOpen({super.key});

  @override
  State<SettingsPopupOpen> createState() => _SettingsPopupOpenState();
}

class _SettingsPopupOpenState extends State<SettingsPopupOpen> {
    ...
    Future.microtask(() async {
      ...
      if (mounted) {
        ...
        setState(() {
          ...
          processStatusMessage = AllConstants().openDoorCleanStatus;
          pressed = false;
          gStatus = 0;
        });
      }
